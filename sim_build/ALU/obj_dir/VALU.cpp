...
VALU::VALU(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_io_opcode{vlSymsp->TOP.io_io_opcode}
    , io_io_zero{vlSymsp->TOP.io_io_zero}
    , io_io_a{vlSymsp->TOP.io_io_a}
    , io_io_b{vlSymsp->TOP.io_io_b}
    , io_io_result{vlSymsp->TOP.io_io_result}
    , rootp{&(vlSymsp->TOP)}
{
